---
title: Cheesing Microsoft Attack Surface Reduction rules

categories: [Redteam]
tags: [Red Team, ASR, Bypass, Exclusions, Tool]    
toc: true
---
...
![hold-up-meme](/assets/img/hold-up-hold-up-meme.gif)
...
![gate-meme](/assets/img/gate_meme.png)
...
![Event Viewer ASR](/assets/img/evt_viewer_asr.png)_Figure 1: ASR exclusion visible in event viewer_
...
The tool will generate the following overview upon being executed (I usually just copy paste it directly):
![ASR Exclusion finder](/assets/img/pwsh_asr_tool_output.png)_Figure 2: ASR exclusion finder tool output_
...
![at.exe dll sideload](/assets/img/sideload_examlpe_asr.gif)
...
![signing](/assets/img/sign_examlpe_asr.gif)
